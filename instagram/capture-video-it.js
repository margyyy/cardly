...
const FRAMES_DIR = path.join(__dirname, 'frames-it');
const HTML_FILE = `file://${path.join(__dirname, 'video-launch-it.html')}`;
const OUTPUT = path.join(__dirname, 'export', 'launch-video-it.mp4');
